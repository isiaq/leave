        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pending Forms
                    <a href="{{url('supervisor_approved')}}" class="btn btn-primary float-right py-2">Back</a>
                </h4>
            </div>
            <div class="card-body">
                <!DOCTYPE html>
                ...
                <main class="container ">
                    <form class="form-container" method="POST" action="{{ url('s_approved_update/'.$approved_edit->id) }}">
                        @csrf
                        @method('PUT')
                        <header>
                    ...
                    to cover for the staff proceeding on leave</span></p><br>
                            <div class="dateover">
                                <input type="text" name=" decl_sig" id="decl_sig" value="{{$approved_edit->decl_sig}}" readonly>

                                <p>Date<input type="date" name="decl_date" id="decl_date" value="{{$approved_edit->date}}"></p>
                            </div>
                        ...
                        <section id="section-4" >
                            ...
                            <div id="signature">
                                <div>
                                    <select name="super_sig" id="super_sig" class="form-control">
                                        <option value="{{$approved_edit->super_sig}}">{{$approved_edit->super_sig}}</option>
                                ...
                                <div>
                                    <input type="text" name=" hod_sig" id="hod_sig" value="{{$approved_edit->hod_sig}}" readonly>
