    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="s_profile_update" autocomplete="off"
          ...
          <div class="card-body">
            <form method="post" action="s_profile_password" autocomplete="off">
              @csrf
              @method('put')
      ...
      <div class="col-md-4">
        <div class="card card-user">
          ...
          <div>
            <form action="{{ url('s_profile_image_update') }}" method="POST" enctype="multipart/form-data">
