...
<div class="desktop moblie">
    <main class="container">
        <form class="form-container" method="POST" action="supervisor_submit_leave">
            @csrf
            <header>
            ...
            <button type="submit" class="btn btn-success mb-4 ">SUBMIT</button>     <a href="/supervisor_dashboard" class="btn btn-danger float-right mb-4">CANCEL</a>
