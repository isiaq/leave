        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pending Forms
                    <a href="{{url('supervisor_pending')}}" class="btn btn-primary float-right py-2">Back</a>
                </h4>
            </div>
            <div class="card-body">
                <!DOCTYPE html>
                ...
                <body>
                    ...
                    <main class="container ">
                        <form class="form-container" method="POST"
                            action="{{ url('s_pending_update/'.$pending_edit->id) }}">
                            @csrf
                            @method('PUT')
                            <header>
                                ...
                                <div id="signature">
                                    <div>
                                        <select name="super_sig" id="super_sig" class="form-control">
                                            <option value="{{$pending_edit->super_sig}}">{{$pending_edit->super_sig}}</option>
                                    ...
                                    <div>
                                        <input type="text" name=" hod_sig" id="hod_sig"
                                            value="{{$pending_edit->hod_sig}}" readonly>
