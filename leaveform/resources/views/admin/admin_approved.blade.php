                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-data-feature">
                                ...
                                <a href="{{url('approved_edit/'.$item->id)}}"><button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                    <i class="zmdi zmdi-edit"></i>
                                </button></a>
                                <button class="item a_approved_delete" data-toggle="tooltip" data-placement="top" title="Delete">
...
$(document).ready(function () {
    ...
    $('.a_approved_delete').click(function (e) {
        e.preventDefault();
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/a_approved_delete/'+delete_xyz,
                        data: data,
