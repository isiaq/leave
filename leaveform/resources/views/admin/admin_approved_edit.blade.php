        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pending Forms
                    <a href="{{url('approved')}}" class="btn btn-primary float-right py-2">Back</a>
                </h4>
            </div>
            <div class="card-body">
                <!DOCTYPE html>
                ...
                <main class="container ">
                    <form class="form-container" method="POST" action="{{ url('approved_update/'.$approved_edit->id) }}">
                        @csrf
                        @method('PUT')
                        <header>
                    ...
                    to cover for the staff proceeding on leave</span></p><br>
                            <div class="dateover">
                                <input type="text" name=" decl_sig" id="decl_sig" value="{{$approved_edit->decl_sig}}">
                        ...
                        <section id="section-4" >
                            ...
                            <div id="signature">
                                <div>
                                    <input type="text" name="super_sig" id="super_sig" value="{{$approved_edit->super_sig}}">
                                ...
                                <div>
                                    <input type="text" name=" hod_sig" id="hod_sig" value="{{$approved_edit->hod_sig}}">
                                ...
                                <div>
                                    <input type="text" name=" hr_sig" id="hr_sig" value="{{$approved_edit->hr_sig}}">
