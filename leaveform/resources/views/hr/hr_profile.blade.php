    ...
    <div class="row">
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body">
            <form method="post" action="hr_profile_update" autocomplete="off"
                ...
                <div class="row">
                  <div class="col-md-7 pr-1">
                    <div class="form-group">
                      ...
                      <input type="email" name="email" class="form-control" placeholder="Email" value="{{ old('email', auth()->user()->email) }}" readonly>
          ...
          <div class="card-body">
            <form method="post" action="hr_profile_password" autocomplete="off">
              @csrf
              @method('put')
      ...
      <div class="col-md-4">
        <div class="card card-user">
          ...
          <div>
            <form action="{{ url('hr_profile_image_update') }}" method="POST" enctype="multipart/form-data">
