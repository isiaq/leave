        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pending Forms
                    <a href="{{url('hr_pending')}}" class="btn btn-primary float-right py-2">Back</a>
                </h4>
            </div>
            <div class="card-body">
                <!DOCTYPE html>
                ...
                <body>
                    ...
                    <main class="container ">
                        <form class="form-container" method="POST"
                            action="{{ url('hr_pending_update/'.$pending_edit->id) }}">
                            @csrf
                            @method('PUT')
                            <header>
                                ...
                                <div id="signature">
                                    ...
                                    <div>
                                        <select name="hr_sig" id="hr_sig" class="form-control">
                                            <option value="{{$pending_edit->hr_sig}}">{{$pending_edit->hr_sig}}</option>
