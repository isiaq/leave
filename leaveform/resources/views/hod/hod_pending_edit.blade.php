        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Pending Forms
                    <a href="{{url('hod_pending')}}" class="btn btn-primary float-right py-2">Back</a>
                </h4>
            </div>
            <div class="card-body">
                <!DOCTYPE html>
                ...
                <body>
                    ...
                    <main class="container ">
                        <form class="form-container" method="POST"
                            action="{{ url('hod_pending_update/'.$pending_edit->id) }}">
                            @csrf
                            @method('PUT')
                            <header>
                            ...
                            <section id="declaration">
                                ...
                                <div class="dateover">
                                    <input type="text" name=" decl_sig" id="decl_sig"
                                        value="{{$pending_edit->decl_sig}}" readonly>
                                ...
                                <div id="signature">
                                    <div>
                                        <input type="text" name="super_sig" id="super_sig"
                                            value="{{$pending_edit->super_sig}}" readonly>
                                    ...
                                    <div>
                                        <select name="hod_sig" id="hod_sig" class="form-control">
                                            <option value="{{$pending_edit->hod_sig}}">{{$pending_edit->hod_sig}}</option>
                                            <option value="pending">PENDING</option>
                                            <option value="approved">APPROVED</option>
                                        </select>
                                        <p><span class="italic">HOD/Subsidiary's Signature</span></p>
                                        <p> <label>Date</label><br>
                                            <input type="date" name=" hod_date" id="hod_date" value="{{$pending_edit->hod_date}}"></p>
                                    </div>
                                    <div>
                                        <input type="text" name=" hr_sig" id="hr_sig" value="{{$pending_edit->hr_sig}}" readonly>
